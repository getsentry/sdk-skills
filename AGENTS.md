# Sentry SDK Agent Skills

A collection of agent skills for managing feature development across Sentry SDKs, primarily designed for [Claude Code](https://claude.ai/claude-code).

This repository is structured as a Claude Code plugin (see `plugins/`), but the skills themselves follow the open [Agent Skills specification](https://agentskills.io) format to maintain compatibility with other tools that adopt the standard.
