...
| `sdk-feature-status` | Check feature implementation status across Sentry SDKs. Use for SDK parity checks, feature rollout status, and cross-SDK coverage audits. |
